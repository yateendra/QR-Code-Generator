...
function QRCodeGenerator({ onGenerate, history }) {
  const [qrValue, setQrValue] = useState('')
  const [debouncedValue] = useDebouncedValue(qrValue, 300)
    ...
    <Paper shadow="sm" p="xl" radius="md" withBorder>
      <Stack gap="lg">
        <Group justify="space-between">
          <Text size="xl" fw={700}>
            <IconQrcode size={24} style={{ verticalAlign: 'middle', marginRight: 8 }} />
            Generate QR Code
          </Text>
